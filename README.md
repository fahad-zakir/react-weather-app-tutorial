...
This React.js tutorial teaches you how to setup an api key and grab the data to change the state of a component with it.  You will also learn how to use bootstrap for React. Detailed comments are used on the components and app.js files.
